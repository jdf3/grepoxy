...
void g::print_g6(ostream *o) {
  if (0 <= n && n <= 62)
    ...
    *o << (char) 126 << itosbbe(n, 12) << itosbbe(n, 6) << itosbbe(n, 0);
  else if (258048 <= n && n <= 68719476735)
    *o << (char) 126 << (char) 126 << itosbbe(n, 30) << itosbbe(n, 24)
       << itosbbe(n, 18) << itosbbe(n, 12) << itosbbe(n, 6) << itosbbe(n, 0);
...
bool g::has_cycle(int c) {
  ...
  switch (c) {
    ...
    default:
      cerr << "has_cycle does not support v = " << v << endl;
  }
}
